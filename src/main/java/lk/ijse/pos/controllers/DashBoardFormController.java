    ...
    private void loadPieChart() {
        ...
        try {
            pieChartData = FXCollections.observableArrayList(
                    new PieChart.Data("Gents", OrderDetailsModel.getDailyGentsSaleCount()),
                    new PieChart.Data("Ladies", OrderDetailsModel.getDailyLadiesSaleCount()),
                    new PieChart.Data("Kids", OrderDetailsModel.getDailyKidsSaleCount()),
                    new PieChart.Data("Other", OrderDetailsModel.getDailyOtherSaleCount())
            );
